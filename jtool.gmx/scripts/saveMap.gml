...
file_text_write_string(f,delim)
file_text_write_string(f,'px:'+intToBase32String(global.savePlayerX))
file_text_write_string(f,delim)
file_text_write_string(f,
    'py:'+padStringLeft(intToBase32String(bin_to_dec(encode_real_double(global.savePlayerY))),13,'0'))
file_text_write_string(f,delim)
