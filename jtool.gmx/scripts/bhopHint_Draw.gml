...
if bhop_show {
    var cursorcolor
    if bhop_offset > 0 cursorcolor = 4634111
    else if bhop_offset < 0 cursorcolor = 16748614
    else if bhop_offset == 0 cursorcolor = c_white
    draw_sprite_ext(sHintCursor,0,line_xcenter+bhop_offset*tick_length,line_y+8,
    1,1,0,cursorcolor,1)
    
    draw_text(xx+90,yy,bhop_offset)
}
